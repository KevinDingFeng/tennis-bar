package com.shenghesun.invite.sms.service;
...
//		String number = "18910739693"; 
//		String code = "123456";
//		String templateCode = "SMS_116583280";
//		System.out.println("code:" + code);
//		System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
//		System.setProperty("sun.net.client.defaultReadTimeout", "10000");
//		final String product = "Dysmsapi";// 短信API产品名称（短信产品名固定，无需修改）
//		final String domain = "dysmsapi.aliyuncs.com";// 短信API产品域名（接口地址固定，无需修改）
//		final String accessKeyId = "LTAIhx3egGT2pXnb";// 你的accessKeyId,参考本文档步骤2
//		final String accessKeySecret = "0Z7eqhCKy7iSnKYke17Ni3m11qddcU";// 你的accessKeySecret，参考本文档步骤2
//		IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", accessKeyId, accessKeySecret);
//		DefaultProfile.addEndpoint("cn-hangzhou", "cn-hangzhou", product, domain);
//		IAcsClient acsClient = new DefaultAcsClient(profile);
//		SendSmsRequest request = new SendSmsRequest();
